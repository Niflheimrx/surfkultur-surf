--[[
  Author: Earu
  Description: Read the bsp file and parse it so we can access the contents inside Lua
  Source: https://github.com/h3xcat/gmod-luabsp/blob/master/luabsp.lua
--]]
...
print( "[LuaBSP] Loaded module successfully" )
